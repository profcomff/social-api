...
GREETINGS = [
    ...
    Как ты о нас узнал? Расскажи о своем опыте в IT.
    """,
    """
    Всем привет! У нас новый участник, давайте приветствовать [{name}](tg://user?id={id}). 
    
    Чем увлекаешься в IT, и как нашел наш чат?
    """,
    """
    Приветствуем на борту, [{name}](tg://user?id={id})!

    Мы всегда рады новым идеям и опыту. Поделись, пожалуйста, своим путем в IT и каким образом ты нас нашел?
    """,
    """
    Салют, [{name}](tg://user?id={id})! Приветствуем тебя в нашем уютном IT уголке!

    Какие направления IT тебе интересны и где ты услышал о нас?
    """,
    """
    Приветик, [{name}](tg://user?id={id})! Добро пожаловать в наш IT клуб!

    Мы здесь, чтобы обучаться и делиться опытом. Расскажи нам немного о своем опыте и как ты нас нашел?
    """,
    """
    Привет, [{name}](tg://user?id={id})! Добро пожаловать в наше IT сообщество!

    Что заинтересовало тебя в нашем клубе и где узнал о нас?
    """,
    """
    Приятно познакомиться, [{name}](tg://user?id={id})! Мы здесь, чтобы обсуждать всё, что связано с IT.

    Какие темы в IT тебя больше всего интересуют и где ты узнал о нас?
    """
]
